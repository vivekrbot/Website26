    ...
    () => {
      ...
      const play = () => {
        ...
        const addTween = (targets: HTMLElement[], at: number) => {
          const vars: gsap.TweenVars = { duration, ease: ease as string, force3D: true, stagger: animationMode === 'evenodd' ? stagger : 0 };
          if (isVertical) {
        ...
        if (animationMode === 'evenodd') {
          ...
          strips.forEach((strip) => {
            ...
            tl.to(strip, vars, d);
            if (colorFrom && colorTo) tl.fromTo(strip, { color: colorFrom }, { color: colorTo, duration, ease: ease as string }, d);
          });
        }
